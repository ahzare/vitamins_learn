...
public abstract class BaseVitaminResourceTestCase {
	...
	public void testGetVitaminsPage() throws Exception {
		...
		assertContains(vitamin1, (List<Vitamin>)page.getItems());
		assertContains(vitamin2, (List<Vitamin>)page.getItems());
		assertValid(page);
	...
	public void testGetVitaminsPageWithPagination() throws Exception {
		Page<Vitamin> totalPage = vitaminResource.getVitaminsPage(
			null, null, null, null);
		...
		Assert.assertEquals(
			vitamins1.toString(), totalCount + 2, vitamins1.size());
		...
		assertContains(vitamin1, (List<Vitamin>)page3.getItems());
		assertContains(vitamin2, (List<Vitamin>)page3.getItems());
		assertContains(vitamin3, (List<Vitamin>)page3.getItems());
	}
	...
	public void testGraphQLGetVitaminsPage() throws Exception {
		...
		long totalCount = vitaminsJSONObject.getLong("totalCount");
		...
		Assert.assertEquals(
			totalCount + 2, vitaminsJSONObject.getLong("totalCount"));
	...
	protected void assertContains(Vitamin vitamin, List<Vitamin> vitamins) {
		boolean contains = false;

		for (Vitamin item : vitamins) {
			if (equals(vitamin, item)) {
				contains = true;
		...
		Assert.assertTrue(vitamins + " does not contain " + vitamin, contains);
	}
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseVitaminResourceTestCase.class);
