...
public class PersistedVitaminUtil {
	...
	public static PersistedVitamin findByUuid_First(
		...
		throws com.denbinger.vitamins.exception.
	...
	private static volatile PersistedVitaminPersistence _persistence;
